...
GLOSSARY: list[dict[str, str]] = [
    {
        "term": "CAGR",
        "fr": "Taux de croissance annualisé composé",
    ...
    {
        "term": "CVaR / ES",
        "fr": "Perte attendue conditionnelle",
