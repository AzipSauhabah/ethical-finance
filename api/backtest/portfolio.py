...
class Portfolio:
    ...
    def buy(
        self,
        dt: date, ticker: str, shares: int, price_eur: float,
        currency: str = "USD", market_cap_eur: float = 2e9, cap_size: str = "mid_cap",
    ) -> Trade | None:
    ...
    def snapshot(self, dt: date, prices_eur: dict[str, float]) -> None:
        ...
        self._snapshots.append((dt, nav, self._total_costs, self._total_taxes,
                                self.cash, invested))
