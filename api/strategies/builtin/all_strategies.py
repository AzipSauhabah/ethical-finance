...
class BuyHoldStrategy(Strategy):
    ...
    @property
    def name(self) -> str:        return "buy_hold"
    @property
    def description(self) -> str: return "Achète et conserve à pondération égale, aucun rééquilibrage."
...
class EqualWeightStrategy(Strategy):
    ...
    @property
    def description(self) -> str: return "Rééquilibrage périodique à pondération égale."
...
class MomentumStrategy(Strategy):
    ...
    @property
    def description(self) -> str: return "Momentum 12-1 mois : long le top quintile, plat le reste."

    @property
    def param_space(self) -> dict: return {"lookback_days": (120, 252), "top_pct": (0.2, 0.5)}
...
class MeanReversionStrategy(Strategy):
    ...
    @property
    def description(self) -> str: return "Mean reversion : achète les actifs sous-cotés (Z < -1.5σ)."

    @property
    def param_space(self) -> dict: return {"window": (10, 40), "z_threshold": (1.0, 2.5)}
...
class SMACrossoverStrategy(Strategy):
    ...
    @property
    def name(self) -> str:        return "sma_crossover"
    @property
    def description(self) -> str: return "Golden cross : long quand SMA 50 > SMA 200."

    @property
    def param_space(self) -> dict: return {"fast": (20, 100), "slow": (100, 250)}
...
class RiskParityStrategy(Strategy):
    ...
    @property
    def name(self) -> str:        return "risk_parity"
    @property
    def description(self) -> str: return "Risk parity : pondération inverse de la vol 20j."

    @property
    def param_space(self) -> dict: return {"vol_window": (10, 60)}
...
class MinVarianceStrategy(Strategy):
    ...
    @property
    def name(self) -> str:        return "min_variance"
    @property
    def description(self) -> str: return "Markowitz min variance — recalibré toutes les 60 séances."
...
class DualMomentumStrategy(Strategy):
    ...
    @property
    def name(self) -> str:        return "dual_momentum"
    @property
    def description(self) -> str: return "Dual momentum Antonacci : meilleur actif si abs momentum > 0, sinon cash."

    @property
    def param_space(self) -> dict: return {"lookback_days": (120, 252)}
...
class AdaptiveTrendStrategy(Strategy):
    ...
    @property
    def name(self) -> str:        return "adaptive_trend"
    @property
    def description(self) -> str: return "Trend following adaptatif : EMA rapide vs EMA lente."

    @property
    def param_space(self) -> dict: return {"ema_fast": (5, 30), "ema_slow": (50, 150)}
...
class MLEnsembleStrategy(Strategy):
    ...
    @property
    def name(self) -> str:        return "ml_ensemble"
    @property
    def description(self) -> str: return "RF + Gradient Boosting — walk-forward refit toutes les 60 séances."
